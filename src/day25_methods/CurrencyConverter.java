...
public class CurrencyConverter {
    ...
    public static double convert (String currencyType, double amount) {  // currencyType and amount - > are the parameters
    ...
    public static void main(String[] args) {
        ...
        System.out.println( convert( "Euro", 100.0) );  // "Euro" and 100.0 --> are the arguments.
